...
import avatar from './assets/Avatars/Admin.png';


const AdminNavbar = () => {

  function showPassword(psd) {
      ...
      <div className="container-fluid">
        ...
        <div className="col-2 d-flex">
          ...
          <div className="navbar-dp-name">
            <p className="pt-3 ms-md-2 ms-lg-3 d-none d-md-block fs-5">Admin</p>
          </div>
        </div>
        ...
        <div className="collapse navbar-collapse ms-md-3 ps-md-3 ms-lg-5 ps-lg-5 col-8" id="navbarSupportedContent">
          <div className="navbar-nav me-auto col">
            <div className="nav-item ms-4 me-4 col">
              <a className="nav-link" href="#"><button className="btn nav-item fs-5"><Icon icon="healthicons:construction-worker-outline" color="black" width="25" height="25" className="me-2"/>Staff</button></a>
            </div>
            <div className="nav-item ms-4 me-4 col">
