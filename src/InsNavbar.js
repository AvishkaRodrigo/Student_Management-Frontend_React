    ...
    return ( 
              ...
              <div className="modal-body">
                <form className='needs-validation' noValidate>
                  ...
                  <div className="d-flex justify-content-center">
                    <button type="button" className="btn btn-danger btn-sm btn-secondary" data-bs-dismiss="modal"  data-bs-target="#Modal2" data-bs-toggle="modal">Change pasword</button>  
                  </div>
                </form>
              </div>
            ...
            <div className="modal-content bg-light">
              ...
              <div className="modal-body">
                ...
                <div className="input-group mb-3">
                    ...
                    <button className="btn btn-secondary " type="button" id="button-addon2 btn-password1" onClick={() => showPassword()}><Icon icon="ant-design:eye-filled" color="#e5e5e5" width="25" height="25" inline={true} /></button>
                  </div> 
                  <div className="input-group mb-3 ">
                    ...
                    <button className="btn btn-secondary" type="button" id="button-addon2 btn-password2" ><Icon icon="ant-design:eye-filled" color="#e5e5e5" width="25" height="25" inline={true} /></button>
                  </div>
                {/* ###################################################################################################Action needed############################################################################## */}
                  <div className='d-flex justify-content-center'>
                  ...
                  <div className="input-group mb-3 ">
                    ...
                    <input type="password" id='password3' className="form-control" placeholder="Enter OTP received to your email here" aria-label="Username" aria-describedby="basic-addon1" /*value={"fname"}*/ />
                    <button className="btn btn-secondary " type="button" id="button-addon2 btn-password3" onClick={() => showPassword()}><Icon icon="ant-design:eye-filled" color="#e5e5e5" width="25" height="25" inline={true} /></button>
                  </div>
                </form>
              </div>
              <div className="modal-footer">
      ...
      <div className='col-2 d-flex'>
        ...
        <div className="navbar-dp-name">
          <p className="pt-3 ms-md-2 ms-lg-3 d-none d-md-block fs-5">Instructor</p>
        </div>
      </div>
        ...
        <div className="collapse navbar-collapse ms-md-3 ps-md-3 ms-lg-5 ps-lg-5 col-8" id="navbarSupportedContent">
          <div className="navbar-nav me-auto col">
            <div className="nav-item ms-5 me-5 col">
            ...
            <div className="nav-item ms-5 me-5 col">
              <a className="nav-link" href="#"><button className="btn nav-item fs-5"><Icon icon="ph:student" color="black" width="25" height="25" className="me-2"/>Student</button></a>
            </div>
            <div className="nav-item ms-5 me-5 col">
              <a className="nav-link" href="#"><button className="btn nav-item fs-5"><Icon icon="fluent:wallet-credit-card-16-regular" color="black" width="25" height="25" className='me-2'/>Earning</button></a>
            </div>
            {/* <li className="nav-item d-flex  items-end">
              <a className="nav-link" href="#"><button className="btn nav-item fs-5">Logout</button></a>
            </li> */}
          </div>
