...
import avatar from './assets/Avatars/Staff.png';
              ...
              <div className="modal-body">
                ...
                <div className="input-group mb-3">
                  ...
                  <div className="input-group mb-3 ">
                    ...
                    <button className="btn btn-secondary" type="button" id="button-addon2 btn-password2" onClick={() => showPassword()}><Icon icon="ant-design:eye-filled" color="#e5e5e5" width="25" height="25" inline={true} /></button>
                  </div>
                {/* ###################################################################################################Action needed############################################################################## */}
                  <div className='d-flex justify-content-center'>
        ...
        <div className="container-fluid">
          ...
          <div className="col-2 d-flex">
            ...
            <div className="navbar-dp-name">
              <p className="pt-3 ms-md-2 ms-lg-3 d-none d-md-block fs-5">Staff</p>
            </div>  
          </div>
          ...
          <div className="collapse navbar-collapse ms-md-3 ps-md-3 ms-lg-5 ps-lg-5 col-8" id="navbarSupportedContent">
            <div className="navbar-nav me-auto col">
              ...
              <div className="nav-item ms-4 me-4 col">
                <a className="nav-link" href="#"><button className="btn nav- fs-5"><Icon icon="ph:student" color="black" width="25" height="25" className="me-2"/>Student</button></a>
              </div>
              <div className="nav-item ms-4 me-4 col">
                <a className="nav-link" href="#"><button className="btn nav-item fs-5"><Icon icon="ph:chalkboard-teacher" color="black" width="25" height="25" className="me-2"/>Instructor</button></a>
              </div>
            </div>
