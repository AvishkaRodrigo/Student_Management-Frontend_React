...
import avatar from './assets/Avatars/Student.png';
              ...
              <div className="modal-body">
                ...
                {/* ###################################################################################################Action needed############################################################################## */}
                  ...
                  <div className="input-group mb-3 ">
                    ...
                    <input type="password" id='otp' className="form-control" placeholder="Enter OTP received to your email here" aria-label="Username" aria-describedby="basic-addon1" /*value={"fname"}*/ />
                    <button className="btn btn-secondary " type="button" id="button-addon2" onClick={() => showPassword(2)}><Icon icon="ant-design:eye-filled" color="#e5e5e5" width="25" height="25" inline={true} /></button>
                  </div>
                </form>
              </div>
              <div className="modal-footer">
        ...
        <nav className="navbar navbar-expand-md navbar-light fixed-bottom">
          ...
          <div className="col-2 d-flex">
            ...
            <div className="navbar-dp-name">
              <p className="pt-3 ms-md-2 ms-lg-3 d-none d-md-block fs-5">Student</p>
            </div>
          </div>
